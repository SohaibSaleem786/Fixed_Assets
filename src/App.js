...
function App() {
  return (
    <>
      <div style={{ backgroundColor: '#edf2ff', minHeight: '100vh', fontFamily:'Verdana'}}>
        <Router basename='/fixed_assets'>
          <AuthProvider>
...
{/* ///////////////////////  Waiter MAINTENANCE //////////////////////////////// */}
   <Route exact path="/Get_Waiter"                element={<Get_Waiter/> }></Route>
   <Route exact path="/Add_Waiter"                    element={<Add_Waiter/> }></Route>
   <Route exact path="/Update_Waiter/:w_id"     element={<Update_Waiter/> }></Route>
  {/* ///////////////////////  Table MAINTENANCE //////////////////////////////// */}
  ...
  <Route exact path="/Get_AccountMaintenance"                element={<Get_AccountMaintenance/> }></Route>
...
{/* <Route exact path="/Update_Table/:t_id"     element={<Update_Table/> }></Route> */}
  ...
  <Route exact path="/Credit_Report"   element={<Credit_Report/>}></Route>
  <Route exact path="/General_Leadger"   element={<General_Leadger/>}></Route>
  ...
  <Route path="/Order_Item/:categoryId/:id" element={<Order_Item />} /> {/* Include categoryId as a parameter */}
  ...
  <Route exact path="/Order_Dashboard"   element={<Order_Dashboard/>}></Route>
...
{/* ///////////////////     Order Kitchen  ////////////////////////// */}
<Route path="/CashReceiptVoucher" element={<CashReceiptVoucher />} /> 
